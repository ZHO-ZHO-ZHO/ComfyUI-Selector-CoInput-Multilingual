...
class Zho_Parameter_Loader:
    ...
    def Zho_co_parameter_loader(self, positive, negative, width, height, batch_size, clip):
        ...
        return ([[clip.encode(positive), {}]], [[clip.encode(negative), {}]], {"samples":latent}, )
...
#------------------------------------------------------------------------------
NODE_CLASS_MAPPINGS = {
    "Zho_Co_Input": Zho_Co_Input,
    "Zho_Co_Loader": Zho_Co_Loader,
    "Zho_Parameter_Loader": Zho_Parameter_Loader,
    "Zho_EmptyLatent_Swap": Zho_EmptyLatent_Swap,
}
